package net.luke.trainingmod.worldgen;
...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_GOJI = registerKey("add_goji");
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_GOJI, new BiomeModifiers.AddFeaturesBiomeModifier(
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(TrainingMod.MODID, name));
    }
}
